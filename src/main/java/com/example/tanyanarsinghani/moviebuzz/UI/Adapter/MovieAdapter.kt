...
class MovieAdapter(var movieData: List<MovieData>, val itemClickListener : ItemClickListener? = null) : RecyclerView.Adapter<MovieAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val view = LayoutInflater.from(p0.context).inflate(R.layout.movie_layout, p0, false);
